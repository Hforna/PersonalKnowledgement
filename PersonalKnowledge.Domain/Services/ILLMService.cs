...
{
    public Task<string> GenerateResponseByContext(string context, string prompt, Guid userId);
    ...
    public Task<List<ChatMessage>> ProcessText(string context, string prompt, Guid userId);
}